package com.oynor.video {
	 ...
	 */
	[Event(name="connectionSuccess", type="com.oynor.video.NetConnectionEvent")]
	/**
	 *  Equal to "NetConnection.Connect.Failed", "NetConnection.Connect.InvalidApp" and "NetConnection.Connect.Rejected"
	 */
	[Event(name="connectionError", type="com.oynor.video.NetConnectionEvent")]
	/**
	 *  Equal to "NetConnection.Connect.Closed" and "NetConnection.Connect.AppShutdown"
	 */
	[Event(name="connectionClosed", type="com.oynor.video.NetConnectionEvent")]
	/**
	 *  Equal to "NetConnection.Call.BadVersion", "NetConnection.Call.Failed" and "NetConnection.Call.Prohibited":
	 */
	[Event(name="callError", type="com.oynor.video.NetConnectionEvent")]
	/**
	 * Equal to "NetConnection.client.onBWDone";
	 */
	[Event(name="bandwidthAvailable", type="com.oynor.video.NetConnectionEvent")]
	/**
	 *  Equal to "SharedObject.Flush.Failed", "SharedObject.BadPersistence", and, "SharedObject.UriMismatch"	
	 */
	[Event(name="soError", type="com.oynor.video.NetConnectionEvent")]
	/**
	 *  Equal to "SharedObject.Flush.Success"
	 */
	[Event(name="soSuccess", type="com.oynor.video.NetConnectionEvent")]
	/**
	 *  Equal to "NetStream.Play.Reset"
	 */
	[Event(name="playlistReset", type="com.oynor.video.NetStreamEvent")]
	/**
	 *  Equal to "NetStream.Play.Start"
	 */
	[Event(name="streamOpen", type="com.oynor.video.NetStreamEvent")]
	/**
	 *  Equal to "NetStream.Pause.Notify"
	 */
	[Event(name="playbackPause", type="com.oynor.video.NetStreamEvent")]
	/**
	 *  Equal to "NetStream.Unpause.Notify"
	 */
	[Event(name="playbackResume", type="com.oynor.video.NetStreamEvent")]
	/**
	 *  Equal to "NetStream.Buffer.Full"
	 */
	[Event(name="bufferFull", type="com.oynor.video.NetStreamEvent")]
	/**
	 *  Equal to "NetStream.Buffer.Empty"
	 */
	[Event(name="bufferEmpty", type="com.oynor.video.NetStreamEvent")]
	/**
	 *  Equal to "NetStream.Buffer.Flush"
	 */
	[Event(name="streamClosed", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Failed" and "NetStream.Play.Failed"
	 */
	[Event(name="playbackError", type="com.oynor.video.NetStreamEvent")]
	/**
	 *  Equal to Equal to "NetStream.Seek.Notify"
	 */
	[Event(name="seekComplete", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Seek.Failed" and "NetStream.Seek.InvalidTime"
	 */
	[Event(name="seekError", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.client.onMetaData"
	 */
	[Event(name="metaDataAvailable", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Publish.Start"
	 */
	[Event(name="publishStart", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Publish.BadName"
	 */
	[Event(name="publishError", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Unpublish.Success"
	 */
	[Event(name="publishUnpublish", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Publish.Idle"
	 */
	[Event(name="publishIdle", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Play.PublishNotify"
	 */
	[Event(name="publishSuccess", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Play.UnpublishNotify"
	 */
	[Event(name="publishUnpublishSuccess", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Record.Start"
	 */
	[Event(name="recordStart", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Record.Stop"
	 */
	[Event(name="recordStop", type="com.oynor.video.NetStreamEvent")]
	/**
	 * Equal to "NetStream.Record.NoAccess" and "NetStream.Record.Failed"
	 */
	[Event(name="recordError", type="com.oynor.video.NetStreamEvent")]
	/**
	 ...
	 */
	[Event(name="streamTimeout", type="com.oynor.video.NetStreamEvent")]
	/**
	 ...
	 * specified amount of time.
	 */
	[Event(name="connectionTimeout", type="com.oynor.video.NetStreamEvent")]
