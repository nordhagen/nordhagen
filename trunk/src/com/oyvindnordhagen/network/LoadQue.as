package com.oyvindnordhagen.network
{
	...
	[Event(name="queStart", type="com.oyvindnordhagen.network.LoadQueEvent")]
	[Event(name="queComplete", type="com.oyvindnordhagen.network.LoadQueEvent")]
	[Event(name="loadComplete", type="com.oyvindnordhagen.network.LoadQueEvent")]
	[Event(name="loadFailed", type="com.oyvindnordhagen.network.LoadQueEvent")]
	...
	public class LoadQue extends EventDispatcher
	{
		...
		{
			dispatchEvent( new OlogEvent( OlogEvent.TRACE , msg , level , this ) );
		}
	}
}