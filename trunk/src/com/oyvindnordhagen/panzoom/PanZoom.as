package com.oyvindnordhagen.panzoom 
{
	...
	[Event(name="zoomStart", type="com.oyvindnordhagen.panzoom.PanZoomEvent")]

	[Event(name="zoomComplete", type="com.oyvindnordhagen.panzoom.PanZoomEvent")]

	[Event(name="panStart", type="com.oyvindnordhagen.panzoom.PanZoomEvent")]

	[Event(name="panComplete", type="com.oyvindnordhagen.panzoom.PanZoomEvent")]
	/**
